	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 temp_cast_0 = (step( length( IN.ase_texcoord3.xyz ) , _Float0 )).xxx;
...
ASEEND*/
//CHKSM=4190AF475374B0CA91FD00977F5E1ACBAEDD2DBD