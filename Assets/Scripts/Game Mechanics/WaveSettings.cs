...
public class SpawnSettings
{
    ...
    public int GetSpawnAmountForWaveLevel(int waveLevel)
    {
        int spawnAmount = SpawnAmountBase + SpawnAmountIncreasePerLevel * (waveLevel - MinimumWaveLevel);
        if (spawnAmount <= 0)
        {
            spawnAmount = SpawnAmountBase;
        }
        return spawnAmount;
    }
